...
rel_vars <- c("se_c", "fungi_max", "rel_weight", "rel_n_w")
other_vars <- c("y", "sd_emp_inv", "rho_med", "p_hetero", "p_fit_x")

rel_vars2 <- c("se_c", "fungi_max", 
...
cors_cmle <- targ_cmle %>% 
  ...
  select(all_of(c(rel_vars, other_vars))) %>%
  nest() %>% 
